...
MAX_N = 10
model_name = "/media/data2/LLM/models/MathSmith-Qwen3-8B-add_30_percent_consist-Step100"
output_path = "./output/qwen/MS_prediction.jsonl"
SAMPLE_NUM_PER_CONCEPT = 5
...
if __name__ == "__main__":
    ...
    with open(output_path, encoding="utf-8") as f:
        for line in f:
            ...
            if item['correctness'] == 0: # 1：正确 0：错误 -1：无法判断
                concept_data.append(item['sampled_concept'])
    ...
    for i, output in enumerate(outputs):
        ...
        for index in range(MAX_N):
            ...
            if model_name.startswith('/'):
                ...
                typed_model_name = model_name.split("/")[1]
            save_rationale_data(prompt, response, f"./output/problems/{typed_model_name}_generated_problems_{MAX_N}.jsonl")
    gen_num += BATCH_SIZE